...
import com.purchaseorderpages.Printreciept;
...
public class logintest extends Baseclass {
	...
	public void printrcpt() {
		Printreciept printreciept=PageFactory.initElements(driver, Printreciept.class);
		printreciept.printdetails();
		logger.info("Print purchase order successfully");
		helper.screenshot(driver);
		logger.pass("Print successfull");
	}
